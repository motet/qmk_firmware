 ...
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |LCTRL |   A  |   R  |   S  |   T  |   D  |-------.    ,-------|   H  |   N  |   E  |   I  |   O  |BackSP|
 * |------+------+------+------+------+------| Lower |    | Raise |------+------+------+------+------+------|
 * |LShift|   Z  |   X  |   C  |   V  |   B  |-------|    |-------|   K  |   M  |   ,  |   .  |   /  |RShift|
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | Down |  Up  | LGUI | /Space  /       \Enter \  | RALT | Left |Right |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
 ...
 [_COLEMAK] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,    LOWER,   RAISE, KC_K,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                             KC_DOWN, KC_UP,   KC_LGUI, KC_SPC, KC_ENT, KC_RALT, KC_LEFT, KC_RGHT
),
 ...
 * |CapsLk|      |      |      |      |      |-------|    |-------|      |      |      |      |      |      |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | PgDn | PgUp | LGUI | /Space  /       \Enter \  | RALT | Home | End  |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
...
[_LOWER] = LAYOUT(
  ...
  KC_CAPS, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                             KC_PGDN, KC_PGUP, KC_LGUI, KC_SPC,  KC_ENT,  KC_RALT,  LGUI(KC_LEFT), RGUI(KC_RGHT)
),
...
[_RAISE] = LAYOUT(
  XXXXXXX, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                      KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_PEQL,
  XXXXXXX, KC_F11,  KC_F12,  XXXXXXX, XXXXXXX, XXXXXXX,                    XXXXXXX, KC_PPLS, XXXXXXX, KC_LBRC, KC_RBRC, KC_GRV,
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                    XXXXXXX, KC_DEL,  XXXXXXX, KC_LCBR, KC_RCBR, XXXXXXX,
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, LOWER,   XXXXXXX,  XXXXXXX, KC_TILD, XXXXXXX, KC_PIPE, KC_BSLS, XXXXXXX,
                             KC_PGDN, KC_PGUP, KC_LGUI, KC_SPC,  KC_ENT,   KC_RALT, LGUI(KC_LEFT), RGUI(KC_RGHT)
),
 ...
 */
  ...
  RM_TOGG, RM_SPDD, RM_VALD, RM_SATD, RM_HUED, RM_PREV, XXXXXXX, XXXXXXX, RM_PREV, RM_HUED, RM_SATD, RM_VALD, RM_SPDD, RM_TOGG,
                             KC_VOLU, KC_VOLD, KC_MPLY, XXXXXXX, XXXXXXX, XXXXXXX, KC_MPRV, KC_MNXT
  )
};
/***********************************************************************************************************/
